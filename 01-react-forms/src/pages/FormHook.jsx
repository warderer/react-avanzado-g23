    ...
    <div className='login'>
      <div className='login-container'>
        ...
        >
          ...
          <input type='text' name='email' placeholder='correo@mail.com' id='email' value={() => {}} onChange={() => {}/* HANDLE INPUT */} />

          <label htmlFor='password'>Password</label>
          <input type='password' name='password' id='password' value={() => {}} onChange={() => {}/* HANDLE INPUT */} />
          <button type='submit'>
            Iniciar Sesion
          </button>
        </form>
